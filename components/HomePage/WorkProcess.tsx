          ...
          {[
            {
              ...
              description:
                "M&M understand the Vision & objectives. Our experts consult with you to craft a detailed plan.",
              icon: <Compass className="h-10 w-10 text-golden" />,
            },
            {
              title: "Design & Development",
              description:
                "M&M work collaboratively to create functional, stylish designs that align with your vision.",
              icon: <Ruler className="h-10 w-10 text-golden" />,
            },
            {
              title: " Execution & Construction",
              description:
                "M&M ArcCon takes over to turn the design into reality, strict adherence to timelines and quality standards.",
              icon: <HardHat className="h-10 w-10 text-golden" />,
            },
            {
              title: "​Lift Installation &  Final Touches",
              description:
                "M&M Lifts installs vertical mobility systems, ensuring a smooth and efficient transition into the finished space.",
              icon: <Building2 className="h-10 w-10 text-golden" />,
            },
            {
              title: " Quality Control & Handover",
              description:
                " M&M conduct thorough inspections to ensure our stringent standards before handing over the project to the client.",
              icon: <HardHat className="h-10 w-10 text-golden" />,
            },
          ].map((step, i) => (
