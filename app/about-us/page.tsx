  ...
  return (
    <div className="grid lg:grid-cols-2 min-h-screen">
      ...
      <div className="relative h-[300px] lg:h-screen">
        <Image
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-MzL135pMF7Ijy5Bd9ITdL83NygOiWo.png"
      ...
      <div className="p-8 lg:p-12 flex flex-col justify-center">
        <div className="max-w-2xl">
          <h2 className="text-amber-500 font-semibold mb-4">Welcome to Home Builder</h2>
          ...
          <Tabs defaultValue="mission" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8">
              <TabsTrigger value="mission" className="data-[state=active]:bg-amber-500 data-[state=active]:text-white">
                Our Mission
              </TabsTrigger>
              <TabsTrigger value="vision" className="data-[state=active]:bg-amber-500 data-[state=active]:text-white">
                Our Vision
              </TabsTrigger>
              <TabsTrigger value="value" className="data-[state=active]:bg-amber-500 data-[state=active]:text-white">
                Our Value
              </TabsTrigger>
            </TabsList>
